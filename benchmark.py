...
def parse_args():
    ...
    parser.add_argument('--clip_quantile_local', default=0.9995, help='Clip quantile to react*')
    parser.add_argument('--gamma', default=0.1, help= "hyperparameter in generalized entropy")
    parser.add_argument('--M', default=100, help='Top M classes is used to calculate score')
